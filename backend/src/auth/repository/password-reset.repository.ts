// src/auth/repository/password-reset.repository.ts
...
export class PasswordResetRepository {
    ...
    async createPasswordReset(passwordReset: Partial<PasswordReset>): Promise<void> {
    ...
    async findLatestPasswordResetByUserId(userId: number): Promise<PasswordReset | undefined> {
    ...
    async updatePasswordResetConsumedAt(id: number): Promise<void> {
