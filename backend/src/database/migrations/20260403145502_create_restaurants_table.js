...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, knex.schema.createTable('restaurants', function (table) {
                    ...
                    table.check("status IN ('active', 'suspended', 'disabled', 'pending')", [], 'chk_restaurants_status');
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, knex.raw('DROP TYPE IF EXISTS restaurant_status_enum CASCADE;')];
                case 1:
                    // Clean up the enum type first, then drop the table
                    _a.sent();
                    return [2 /*return*/, knex.schema.dropTableIfExists('restaurants')];
            }
        });
    });
}
