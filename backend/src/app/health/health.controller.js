...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        function HealthController_1(knex) {
            this.knex = (__runInitializers(this, _instanceExtraInitializers), knex);
        }
        HealthController_1.prototype.checkHealth = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            throw new common_1.ServiceUnavailableException('Database connection failed');
    ...
    (function () {
        ...
        _checkHealth_decorators = [(0, common_1.Get)(), openapi.ApiResponse({ status: 200 })];
