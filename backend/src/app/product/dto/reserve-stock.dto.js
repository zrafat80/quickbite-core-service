...
exports.ReserveStockDTO = exports.ReserveStockItemDTO = void 0;
var openapi = require("@nestjs/swagger");
var class_transformer_1 = require("class-transformer");
var class_validator_1 = require("class-validator");
var ReserveStockItemDTO = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            ...
            ReserveStockItemDTO._OPENAPI_METADATA_FACTORY = function () {
...
exports.ReserveStockItemDTO = ReserveStockItemDTO;
var ReserveStockDTO = function () {
    var _a;
    var _items_decorators;
    var _items_initializers = [];
    var _items_extraInitializers = [];
    return _a = /** @class */ (function () {
            function ReserveStockDTO() {
                this.items = __runInitializers(this, _items_initializers, void 0);
                __runInitializers(this, _items_extraInitializers);
            }
            ReserveStockDTO._OPENAPI_METADATA_FACTORY = function () {
                return { items: { required: true, type: function () { return [require("./reserve-stock.dto").ReserveStockItemDTO]; }, minItems: 1 } };
            };
            return ReserveStockDTO;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _items_decorators = [(0, class_validator_1.IsArray)(), (0, class_validator_1.ArrayMinSize)(1), (0, class_validator_1.ValidateNested)({ each: true }), (0, class_transformer_1.Type)(function () { return ReserveStockItemDTO; })];
