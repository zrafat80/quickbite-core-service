...
var time_utils_1 = require("../../../../../../../../../../../src/pkg/utils/time.utils"); // Using your existing TimeUtils
var PermissionCacheService = function () {
    ...
    var PermissionCacheService = _classThis = /** @class */ (function () {
        function PermissionCacheService_1(permissionRepo) {
            this.permissionRepo = permissionRepo;
            this.cache = new Map();
            // Using the TimeUtils from your previous context for consistency!
            this.TTL = time_utils_1.TimeUtils.hoursToMs(1);
        }
        PermissionCacheService_1.prototype.getPermissions = function (roleName) {
            return __awaiter(this, void 0, void 0, function () {
                var cached, permissions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            cached = this.cache.get(roleName);
                            ...
                            return [4 /*yield*/, this.permissionRepo.getPermissionsByRoleName(roleName)];
                        case 1:
                            permissions = _a.sent();
                            // 3. Save to Cache
                            this.cache.set(roleName, { permissions: permissions, cachedAt: Date.now() });
                            return [2 /*return*/, permissions];
                    }
                });
            });
        };
        PermissionCacheService_1.prototype.hasPermission = function (permissions, resource, action) {
            return permissions.includes("".concat(resource, ":").concat(action));
        };
        // 🌟 ENTERPRISE BONUS: You absolutely need this!
        // Call this whenever an admin changes a role's permissions in the DB.
        PermissionCacheService_1.prototype.clearCache = function (roleName) {
            if (roleName) {
