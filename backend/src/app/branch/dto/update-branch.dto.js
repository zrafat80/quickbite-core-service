...
exports.UpdateBranchStatusDTO = exports.UpdateBranchDTO = void 0;
var openapi = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var enums_1 = require("../enums");
var UpdateBranchDTO = function () {
    var _a;
    ...
    var _acceptOrders_decorators;
    var _acceptOrders_initializers = [];
    var _acceptOrders_extraInitializers = [];
    return _a = /** @class */ (function () {
            function UpdateBranchDTO() {
                ...
                this.acceptOrders = (__runInitializers(this, _currency_extraInitializers), __runInitializers(this, _acceptOrders_initializers, void 0));
                __runInitializers(this, _acceptOrders_extraInitializers);
            }
            UpdateBranchDTO._OPENAPI_METADATA_FACTORY = function () {
                return { label: { required: false, type: function () { return String; } }, addressText: { required: false, type: function () { return String; } }, lat: { required: false, type: function () { return Number; } }, lng: { required: false, type: function () { return Number; } }, opensAt: { required: false, type: function () { return String; } }, closesAt: { required: false, type: function () { return String; } }, deliveryRadius: { required: false, type: function () { return Number; }, minimum: 0 }, currency: { required: false, enum: require("../enums").Currency }, acceptOrders: { required: false, type: function () { return Boolean; } } };
            };
        ...
        (function () {
            ...
            _addressText_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _lat_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _lng_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _opensAt_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _closesAt_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _deliveryRadius_decorators = [(0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(0), (0, class_validator_1.IsOptional)()];
            _currency_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(enums_1.Currency)];
            _acceptOrders_decorators = [(0, class_validator_1.IsBoolean)(), (0, class_validator_1.IsOptional)()];
            ...
            __esDecorate(null, null, _acceptOrders_decorators, { kind: "field", name: "acceptOrders", static: false, private: false, access: { has: function (obj) { return "acceptOrders" in obj; }, get: function (obj) { return obj.acceptOrders; }, set: function (obj, value) { obj.acceptOrders = value; } }, metadata: _metadata }, _acceptOrders_initializers, _acceptOrders_extraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
        _a;
}();
exports.UpdateBranchDTO = UpdateBranchDTO;
var UpdateBranchStatusDTO = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function UpdateBranchStatusDTO() {
                this.isActive = __runInitializers(this, _isActive_initializers, void 0);
                this.commission = (__runInitializers(this, _isActive_extraInitializers), __runInitializers(this, _commission_initializers, void 0));
                __runInitializers(this, _commission_extraInitializers);
            }
            UpdateBranchStatusDTO._OPENAPI_METADATA_FACTORY = function () {
                return { isActive: { required: false, type: function () { return Boolean; } }, commission: { required: false, type: function () { return Number; }, minimum: 0, maximum: 100 } };
            };
            return UpdateBranchStatusDTO;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _isActive_decorators = [(0, class_validator_1.IsBoolean)(), (0, class_validator_1.IsOptional)()];
            _commission_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.Min)(0), (0, class_validator_1.Max)(100), (0, class_validator_1.IsOptional)()];
...
exports.UpdateBranchStatusDTO = UpdateBranchStatusDTO;
