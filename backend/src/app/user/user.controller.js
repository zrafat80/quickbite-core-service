...
var UserController = function () {
        ...
        UserController_1.prototype.getMe = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    return [2 /*return*/, this.userService.getByUserId(userId)];
                });
            });
        };
        UserController_1.prototype.updateProfile = function (req, body) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                var _a;
                return __generator(this, function (_b) {
                    userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId;
                    return [2 /*return*/, this.userService.updateProfile(userId, body)];
                });
            });
        };
    ...
    (function () {
        ...
        _getMe_decorators = [(0, common_1.Get)('me'), (0, common_1.UseGuards)(jwtGuard_1.JwtAuthGuard), openapi.ApiResponse({ status: 200 })];
        _updateProfile_decorators = [(0, common_1.Patch)('me'), (0, common_1.UseGuards)(jwtGuard_1.JwtAuthGuard), openapi.ApiResponse({ status: 200 })];
