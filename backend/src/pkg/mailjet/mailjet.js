...
var MailjetClient = /** @class */ (function () {
    function MailjetClient(apiKey, secretKey, defaultFromEmail, defaultFromName) {
        this.defaultFromEmail = defaultFromEmail;
        this.defaultFromName = defaultFromName;
        this.client = new node_mailjet_1.default({ apiKey: apiKey, apiSecret: secretKey });
    }
    MailjetClient.prototype.sendHtmlEmail = function (to, subject, html) {
...
exports.MailjetClient = MailjetClient;
