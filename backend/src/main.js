...
var database_error_filter_1 = require("./lib/filters/database-error.filter");
var cookie_parser_1 = require("cookie-parser");
var config_1 = require("@nestjs/config");
var helmet_1 = require("helmet");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, origin, config, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    swagger_1.SwaggerModule.setup('api/docs/swagger', app, document);
                    ...
                    // ✅ Filters
                    app.useGlobalFilters(new database_error_filter_1.DatabaseErrorFilter());
                ...
                case 2:
                    _a.sent();
                    console.log("\uD83D\uDE80 Core Service backend listening on port ".concat(port));
                    return [2 /*return*/];
            }
        });
    });
