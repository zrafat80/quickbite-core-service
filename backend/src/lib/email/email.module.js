...
var mailjet_1 = require("../../pkg/mailjet/mailjet");
...
var EmailModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            providers: [
                {
                    provide: email_constants_1.EMAIL_PROVIDER_TOKEN,
                    ...
                    useFactory: function (configService) {
                        ...
                        var mailjetConfig = configService.get('mailjet');
                        // 4. Instantiate the dumb tool using the config
                        var mailjet = new mailjet_1.MailjetClient(mailjetConfig.apiKey, mailjetConfig.secretKey, mailjetConfig.fromEmail, mailjetConfig.fromName);
                        // 5. Return it shaped exactly like the IEmailProvider blueprint
                        return {
                            send: function (to, subject, html) { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, mailjet.sendHtmlEmail(to, subject, html)];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
            ...
            exports: [email_constants_1.EMAIL_PROVIDER_TOKEN],
        })];
