...
var DatabaseModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            providers: __spreadArray(__spreadArray([], database_providers_1.databaseProviders, true), [database_service_1.DatabaseService], false),
            exports: __spreadArray(__spreadArray([], database_providers_1.databaseProviders, true), [database_service_1.DatabaseService], false),
        })];
