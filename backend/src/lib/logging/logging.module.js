...
var database_logger_service_1 = require("./database-logger.service");
var logs_controller_1 = require("./logs.controller");
var request_context_service_1 = require("../context/request-context.service");
var LoggingModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            providers: [database_logger_service_1.DatabaseLoggerService, request_context_service_1.RequestContextService],
            controllers: [logs_controller_1.LogsController],
            exports: [database_logger_service_1.DatabaseLoggerService, request_context_service_1.RequestContextService],
        })];
