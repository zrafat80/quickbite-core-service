...
var idempotency_decorator_1 = require("./idempotency.decorator");
var IdempotencyInterceptor = function () {
    ...
    var IdempotencyInterceptor = _classThis = /** @class */ (function () {
        function IdempotencyInterceptor_1(reflector, cacheManager) {
            this.reflector = reflector;
            this.cacheManager = cacheManager;
        }
        IdempotencyInterceptor_1.prototype.intercept = function (context, next) {
            return __awaiter(this, void 0, void 0, function () {
                var request, method, options, idempotencyKey, cacheKey, TTL_24_HOURS, cachedResponse, error_1;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            options = this.reflector.get(idempotency_decorator_1.IDEMPOTENCY_KEY_METADATA, context.getHandler());
                            if (!options)
                                return [2 /*return*/, next.handle()];
                            ...
                            cacheKey = "idempotency:".concat(method, ":").concat(request.originalUrl, ":").concat(idempotencyKey);
                        ...
                        case 2:
                            ...
                            if (cachedResponse) {
                                ...
                                if (cachedResponse === 'PROCESSING') {
                                    throw new common_1.ConflictException('Request is currently processing. Please do not retry.');
                                }
                                return [2 /*return*/, (0, rxjs_1.of)(JSON.parse(cachedResponse))];
                            }
                            // 3. CLAIM THE LOCK BEFORE EXECUTING
                            return [4 /*yield*/, this.cacheManager.set(cacheKey, 'PROCESSING', TTL_24_HOURS)];
                        case 3:
                            // 3. CLAIM THE LOCK BEFORE EXECUTING
                            _a.sent();
                            return [3 /*break*/, 5];
                        case 4:
                            error_1 = _a.sent();
                            if (options.strict && !(error_1 instanceof common_1.ConflictException)) {
                                throw new common_1.ServiceUnavailableException('Idempotency storage is unavailable. Request blocked.');
                            }
                        ...
                        return [2 /*return*/, next.handle().pipe((0, operators_1.tap)(function (responseBody) {
                                // 5. SUCCESS: Overwrite the 'PROCESSING' lock with the actual response
                                _this.cacheManager
                                    .set(cacheKey, JSON.stringify(responseBody), TTL_24_HOURS)
                                    .catch(function (err) { return console.error("Failed to update idempotency key: ".concat(cacheKey), err); });
                            }), 
                            // 6. ERROR HANDLING: Delete the lock so they can try again
                            (0, operators_1.catchError)(function (error) {
                                _this.cacheManager
                                    .del(cacheKey)
                                    .catch(function (e) { return console.error("Failed to release lock: ".concat(cacheKey), e); });
