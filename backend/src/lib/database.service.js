...
var DatabaseService = function () {
    ...
    var DatabaseService = _classThis = /** @class */ (function () {
        ...
        DatabaseService_1.prototype.onApplicationShutdown = function (signal) {
            return __awaiter(this, void 0, void 0, function () {
                var error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.logger.log("Received ".concat(signal, ". Gracefully shutting down database pool..."));
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                        ...
                        case 3:
                            error_1 = _a.sent();
                            this.logger.error('❌ Error while closing database connection', error_1);
                            return [3 /*break*/, 4];
