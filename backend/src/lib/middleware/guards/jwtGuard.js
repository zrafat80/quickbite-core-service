...
var auth_constants_1 = require("../../../app/auth/auth.constants");
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function () {
        ...
        function JwtAuthGuard_1(authUtils) {
        ...
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            ...
            var token = (_a = request.cookies) === null || _a === void 0 ? void 0 : _a.access_token;
            if (!token) {
                throw new common_1.UnauthorizedException(auth_constants_1.AUTH_ERRORS.UNAUTHORIZED_ACCESS);
            }
            try {
                // 3. Verify the token
                var payload = this.authUtils.verifyAccessToken(token);
                ...
                throw new common_1.UnauthorizedException(auth_constants_1.AUTH_ERRORS.TOKEN_EXPIRED);
            }
        };
