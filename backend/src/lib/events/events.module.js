...
var message_broker_service_1 = require("./message-broker.service");
var outbox_drain_service_1 = require("./outbox-drain.service");
var outbox_repository_1 = require("./outbox.repository");
/**
...
var EventsModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            providers: [message_broker_service_1.MessageBrokerService, outbox_repository_1.OutboxRepository, outbox_drain_service_1.OutboxDrainService],
            exports: [message_broker_service_1.MessageBrokerService, outbox_repository_1.OutboxRepository, outbox_drain_service_1.OutboxDrainService],
        })];
