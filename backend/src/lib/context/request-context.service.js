...
var RequestContextService = function () {
    ...
    var RequestContextService = _classThis = /** @class */ (function () {
        function RequestContextService_1() {
        }
        RequestContextService_1.prototype.run = function (correlationId, callback) {
            var store = new Map().set('correlationId', correlationId);
            RequestContextService.storage.run(store, callback);
        };
        RequestContextService_1.prototype.getCorrelationId = function () {
            var _a;
            return (_a = RequestContextService.storage.getStore()) === null || _a === void 0 ? void 0 : _a.get('correlationId');
        };
    ...
    _classThis.storage = new async_hooks_1.AsyncLocalStorage();
    (function () {
